...
from ._exceptions import APIStatusError, YolkenTest7cError
...
class YolkenTest7c(SyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new synchronous YolkenTest7c client instance.
        ...
        if base_url is None:
            base_url = os.environ.get("YOLKEN_TEST_7C_BASE_URL")
        if base_url is None:
    ...
    @cached_property
    def with_raw_response(self) -> YolkenTest7cWithRawResponse:
        return YolkenTest7cWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> YolkenTest7cWithStreamedResponse:
        return YolkenTest7cWithStreamedResponse(self)
...
class AsyncYolkenTest7c(AsyncAPIClient):
    # client options
    api_key: str
    ...
    def __init__(
        ...
        *,
        ...
        """Construct a new async AsyncYolkenTest7c client instance.
    ...
    @cached_property
    def with_raw_response(self) -> AsyncYolkenTest7cWithRawResponse:
        return AsyncYolkenTest7cWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncYolkenTest7cWithStreamedResponse:
        return AsyncYolkenTest7cWithStreamedResponse(self)
...
class YolkenTest7cWithRawResponse:
    _client: YolkenTest7c

    def __init__(self, client: YolkenTest7c) -> None:
        self._client = client
...
class AsyncYolkenTest7cWithRawResponse:
    _client: AsyncYolkenTest7c

    def __init__(self, client: AsyncYolkenTest7c) -> None:
        self._client = client
...
class YolkenTest7cWithStreamedResponse:
    _client: YolkenTest7c
...
class AsyncYolkenTest7cWithStreamedResponse:
    _client: AsyncYolkenTest7c
